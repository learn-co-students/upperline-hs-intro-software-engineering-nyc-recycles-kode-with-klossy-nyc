...
def all_keys(recycle_bin)
  recycle_bin.each_key do |recycle_key|
    puts recycle_key
  end
end
...
def all_data(recycle_bin)
  recycle_bin.each_value do |recycle_value|
    puts recycle_value
  end
end
...
def key_and_data(recycle_bin)
  recycle_bin.each do |recycle_key, recycle_value|
    puts "The #{recycle_key} is #{recycle_value}"
  end
end
